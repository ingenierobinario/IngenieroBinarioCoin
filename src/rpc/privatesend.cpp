// Copyright (c) 2019-2020 The Ingenierobinariocoin Core developers
...
static const CRPCCommand commands[] =
    { //  category              name                      actor (function)         argNames
        //  --------------------- ------------------------  ---------------------------------
        { "ingenierobinariocoin",               "getpoolinfo",            &getpoolinfo,            {} },
        { "ingenierobinariocoin",               "getprivatesendinfo",     &getprivatesendinfo,     {} },
#ifdef ENABLE_WALLET
        { "ingenierobinariocoin",               "privatesend",            &privatesend,            {} },
#endif // ENABLE_WALLET
};
