...
UniValue debug(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            " - \"ingenierobinariocoin\" activates all Ingenierobinariocoin-specific categories at once;\n"
            ...
            "\nExamples:\n"
            + HelpExampleCli("debug", "ingenierobinariocoin")
            + HelpExampleRpc("debug", "ingenierobinariocoin+net")
        );
...
UniValue validateaddress(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "\nReturn information about the given ingenierobinariocoin address.\n"
            "\nArguments:\n"
            "1. \"address\"     (string, required) The ingenierobinariocoin address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,       (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"address\", (string) The ingenierobinariocoin address validated\n"
...
UniValue verifymessage(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 3)
        throw std::runtime_error(
            ...
            "\nArguments:\n"
            "1. \"address\"         (string, required) The ingenierobinariocoin address to use for the signature.\n"
...
UniValue echo(const JSONRPCRequest& request)
{
    if (request.fHelp)
        throw std::runtime_error(
            ...
            "ingenierobinariocoin-cli and the GUI. There is no server-side difference."
        );
...
{ //  category              name                      actor (function)         argNames
  //  --------------------- ------------------------  -----------------------  ----------
    ...
    /* Ingenierobinariocoin features */
    { "ingenierobinariocoin",               "mnsync",                 &mnsync,                 {} },
    { "ingenierobinariocoin",               "spork",                  &spork,                  {"arg0","value"} },
