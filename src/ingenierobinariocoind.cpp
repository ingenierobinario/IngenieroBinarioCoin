 ...
 *
 * This is the developer documentation of the reference client for an experimental new digital currency called Ingenierobinariocoin (https://www.ingenierobinariocoin.org/),
 * which enables instant payments to anyone, anywhere in the world. Ingenierobinariocoin uses peer-to-peer technology to operate
...
bool AppInit(int argc, char* argv[])
{
    ...
    // Parameters
    //
    // If Qt is used, parameters/ingenierobinariocoin.conf are parsed in qt/ingenierobinariocoin.cpp's main()
    ...
    try
    {
        ...
        {
#if HAVE_DECL_DAEMON
            fprintf(stdout, "Ingenierobinariocoin Core server starting\n");
