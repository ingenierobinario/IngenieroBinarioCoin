...
// Copyright (c) 2014-2020 The Ingenierobinariocoin Core developers
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 10 * 60 * 60; // Ingenierobinariocoin: 1 horas
        consensus.nPowTargetSpacing = 1 * 60; // Ingenierobinariocoin: 1 minuto
        ...
        nDefaultPort = 1993;
        vAlertPubKey = uint256S("0x04d2ff0c511c8ae099086ecf25768cc86065c572f1fa3865bd64520e3dbd0fdba85a3e85dc502a44a69786a254daff3b65b92ad5a30c0248c9e9ab8b897e193372");
        nTargetTimespan = 10 * 60 * 60;   
        nTargetSpacing = 1 * 60;
        nPruneAfterHeight = 100000;
        const char* pszTimestamp = "Creación de ingenierobinariocoin para mi comunidad el 14/12/2020";
        scriptPubKey =  uint256S("0x04d94a2f4e5ac664ba36ad9ceaabac1e7d3adf9db935d611c9bf0670a4e8600c1d9592ba80a3b2fa12ea362bdca26138c0483a33d0c2192375ea9687e95a90027e");     

        genesis.nTime =  1607969208;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 206841;
        nStartMasternodePayments =  1607969208;


        genesis = CreateGenesisBlock(1607969208, 206841, 0x1e0ffff0, 1, 50 * COIN );
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000a01c5313ef0350a49a7f0bdc5fc59f116a88a4ac969db4cab3f0be293a5"));
        assert(genesis.hashMerkleRoot == uint256S("0x0e176363f5a7636224b26320bddd6f6a1cf717086e0abe7a9fa7077b96e0b59"));

        strSporkKey = uint256S("0x045ef94cce68667e3174046d433482be39b089a4c17ef254c72ade2f6816f126b9d14b6b687a729517efb4c0d8aa223baf72cd7f1cedc4d4be4f2e87d45e866ca1");
        strMasternodePaymentsPubKey = int256S("0x045ef94cce68667e3174046d433482be39b089a4c17ef254c72ade2f6816f126b9d14b6b687a729517efb4c0d8aa223baf72cd7f1cedc4d4be4f2e87d45e866ca1");
        ...
        vSeeds.emplace_back("dnsseed.ingenierobinariocoin.org");
        vSeeds.emplace_back("dnsseed.dashdot.io");

        // Ingenierobinariocoin addresses start with 'X'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,76);
        // Ingenierobinariocoin script addresses start with '7'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,16);
        // Ingenierobinariocoin private keys start with '7' or 'X'
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,204);
        // Ingenierobinariocoin BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x88, 0xB2, 0x1E};
        // Ingenierobinariocoin BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x88, 0xAD, 0xE4};

        // Ingenierobinariocoin BIP44 coin type is '5'
        nExtCoinType = 5;
        ...
        checkpointData = {
            {
                {0, uint256S("0x00000a01c5313ef0350a49a7f0bdc5fc59f116a88a4ac969db4cab3f0be293a5")},
            }
        };

        chainTxData = ChainTxData{
            1607969208, // * UNIX timestamp of last known number of transactions (Block 1344000)
...
public:
    CTestNetParams() {
        ...
        consensus.powLimit = uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"); // ~uint256(0) >> 20
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Ingenierobinariocoin: 1 day
        consensus.nPowTargetSpacing = 2.5 * 60; // Ingenierobinariocoin: 2.5 minutes
        ...
        nDefaultPort = 11993;
        vAlertPubKey = uint256S("0x04bdd6c91f46f0a80c1b82dc2179a71b2d961d7b936a2594579f86b740c4955432e70bd3873cbefd156a2ee89ec993469f1b93f6c843793dc4f8866077ab779648");
        nPruneAfterHeight = 1000;
        nStartMasternodePayments =  1607970333;

        genesis = CreateGenesisBlock(1607970333, 36966, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        strSporkKey = uint256S("0x040fc8b6ce169ec9aed2606ddf9acf035fc61a7d46619c89ac1e11756a99b464bba3eae217b6afd293a52484eff561908c6a0e7130bcd5c54a95e82710947766de");
        strMasternodePaymentsPubKey = int256S("0x040fc8b6ce169ec9aed2606ddf9acf035fc61a7d46619c89ac1e11756a99b464bba3eae217b6afd293a52484eff561908c6a0e7130bcd5c54a95e82710947766de");
        ...
        // Testnet Ingenierobinariocoin addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Testnet Ingenierobinariocoin script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Testnet Ingenierobinariocoin BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Testnet Ingenierobinariocoin BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Testnet Ingenierobinariocoin BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
        ...
        chainTxData = ChainTxData{
            1607970333, // * UNIX timestamp of last known number of transactions (Block 387900)
...
public:
    CDevNetParams() {
        ...
        nDefaultPort = 19799;
        nPruneAfterHeight = 1000;
        nStartMasternodePayments =  1607970975;

        genesis = CreateGenesisBlock(1607970975, 0, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
...
public:
    CRegTestParams() {
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].nTimeout = 199319931993ULL;
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].bit = 0;
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nStartTime = 0;
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nTimeout = 199319931993ULL;
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0001].bit = 1;
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0001].nStartTime = 0;
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0001].nTimeout = 199319931993ULL;
        consensus.vDeployments[Consensus::DEPLOYMENT_BIP147].bit = 2;
        consensus.vDeployments[Consensus::DEPLOYMENT_BIP147].nStartTime = 0;
        consensus.vDeployments[Consensus::DEPLOYMENT_BIP147].nTimeout = 199319931993ULL;
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0003].bit = 3;
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0003].nStartTime = 0;
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0003].nTimeout = 199319931993ULL;
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0008].bit = 4;
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0008].nStartTime = 0;
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0008].nTimeout = 199319931993ULL;
        consensus.vDeployments[Consensus::DEPLOYMENT_REALLOC].bit = 5;
        consensus.vDeployments[Consensus::DEPLOYMENT_REALLOC].nStartTime = 0;
        consensus.vDeployments[Consensus::DEPLOYMENT_REALLOC].nTimeout = 199319931993ULL;
        ...
        // Regtest Ingenierobinariocoin addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Regtest Ingenierobinariocoin script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Regtest Ingenierobinariocoin BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Regtest Ingenierobinariocoin BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Regtest Ingenierobinariocoin BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
