...
public:
    explicit AmountValidator(QObject *parent) :
        QValidator(parent),
        currentUnit(BitcoinUnits::INGENIEROBINARIOCOIN) {}
...
public:
    ...
    QSize minimumSizeHint() const
    {
        ...
        int h = 0;
        int w = fm.width(BitcoinUnits::format(BitcoinUnits::INGENIEROBINARIOCOIN, BitcoinUnits::maxMoney(), false, BitcoinUnits::separatorAlways));
