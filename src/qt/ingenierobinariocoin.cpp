...
{
    return QCoreApplication::translate("ingenierobinariocoin-core", psz).toStdString();
}
...
static void initTranslations(QTranslator &qtTranslatorBase, QTranslator &qtTranslator, QTranslator &translatorBase, QTranslator &translator)
{
    ...
    // Load e.g. bitcoin_de.qm (shortcut "de" needs to be defined in ingenierobinariocoin.qrc)
    if (translatorBase.load(lang, ":/translations/"))
        QApplication::installTranslator(&translatorBase);

    // Load e.g. bitcoin_de_DE.qm (shortcut "de_DE" needs to be defined in ingenierobinariocoin.qrc)
...
/** Class encapsulating Ingenierobinariocoin Core startup and shutdown.
...
/** Main Ingenierobinariocoin application object */
...
#include <qt/ingenierobinariocoin.moc>
...
void BitcoinApplication::initializeResult(bool success)
{
    ...
    if(success)
    {
        ...
        // ingenierobinariocoin: URIs or payment requests:
...
{
    QMessageBox::critical(0, "Runaway exception", BitcoinGUI::tr("A fatal error occurred. Ingenierobinariocoin Core can no longer continue safely and will quit.") + QString("\n\n") + message);
    ::exit(EXIT_FAILURE);
}
...
int main(int argc, char *argv[])
{
    ...
    Q_INIT_RESOURCE(ingenierobinariocoin);
    ...
    /// 6. Determine availability of data directory and parse ingenierobinariocoin.conf
    ...
    // ingenierobinariocoin: links repeatedly have their payment requests routed to this process:
