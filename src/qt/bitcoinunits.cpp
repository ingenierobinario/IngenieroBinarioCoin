...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(INGENIEROBINARIOCOIN);
...
QString BitcoinUnits::name(int unit)
{
    if(Params().NetworkIDString() == CBaseChainParams::MAIN)
    {
        switch(unit)
        {
            case INGENIEROBINARIOCOIN: return QString("INGENIEROBINARIOCOIN");
    ...
    else
    {
        switch(unit)
        {
            case INGENIEROBINARIOCOIN: return QString("tDASH");
...
QString BitcoinUnits::description(int unit)
{
    if(Params().NetworkIDString() == CBaseChainParams::MAIN)
    {
        ...
        {
            case INGENIEROBINARIOCOIN: return QString("Ingenierobinariocoin");
            case mDASH: return QString("Milli-Ingenierobinariocoin (1 / 1" THIN_SP_UTF8 "000)");
            case uDASH: return QString("Micro-Ingenierobinariocoin (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
            case duffs: return QString("Ten Nano-Ingenierobinariocoin (1 / 100" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
            default: return QString("???");
        }
    }
    else
    {
        switch(unit)
        {
            case INGENIEROBINARIOCOIN: return QString("TestDashs");
...
qint64 BitcoinUnits::factor(int unit)
{
    switch(unit)
    {
    case INGENIEROBINARIOCOIN:  return 100000000;
...
int BitcoinUnits::decimals(int unit)
{
    switch(unit)
    {
    case INGENIEROBINARIOCOIN: return 8;
    case mDASH: return 5;
    case uDASH: return 2;
    case duffs: return 0;
    default: return 0;
