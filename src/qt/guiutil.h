...
/** Utility functions used by the Ingenierobinariocoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "ingenierobinariocoin:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    // Open ingenierobinariocoin.conf
    void openConfigfile();	
    ...
    /** Load ingenierobinariocoin specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a ingenierobinariocoin specific theme is activated (light/dark).*/
